...
//TODO: THIS PAGE SHOULD BE SHOWN WHEN A CHAMP IS CLICKED TO SHOW HIS INDIVIDUAL STATS
		...
		<Container className={classes.root}>
			<Paper className={classes.paper}>
				<Grid container spacing={1} justify='center'>
					<Grid item>
						<Avatar
							src={`http://ddragon.leagueoflegends.com/cdn/10.12.1/img/champion/${champion}.png`}
						/>
					</Grid>
					<Grid item xs={12}>
